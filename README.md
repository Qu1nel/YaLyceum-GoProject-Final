...
*   **[ ] Аутентификация:**
    *   **[ ]** Регистрация (`/register`) и Логин (`/login`) с хешированием паролей (bcrypt).
...
*   **[ ] Тестирование:**
    *   **[ ]** Юнит-тесты для ключевых компонентов (хешер, сервисы с моками, репозитории с моками - частично).
